# -*- coding: utf-8 -*-
"""
Kit Radio IA - Prière du matin (05:00 par défaut)
Génère une longue prière du matin (15+ minutes) avec Gemini.
...
SUJETS = [
    f"Prière pour {config.PAYS_OU_COMMUNAUTE} et sa délivrance",
...
if config.NOM_DIASPORA:
    SUJETS.insert(1, f"Prière pour {config.NOM_DIASPORA}")
...
- Commencer EXACTEMENT par : "Bienvenue à notre moment de prière du matin sur {config.STATION_NOM}. En ce matin béni, nous nous tournons vers notre Père céleste pour Lui consacrer cette nouvelle journée."
- Minimum 600 mots
...
- TOUT en {config.STATION_LANGUE}
- Minimum 600 mots
- Transition naturelle : "Père céleste, nous Te présentons maintenant {config.PAYS_OU_COMMUNAUTE}..."
- Intercession pour {config.PAYS_OU_COMMUNAUTE} : enfants, familles, éducation, sécurité, économie, l'Église
- Intercession pour{_DIASPORA_LIGNE if _DIASPORA_LIGNE else " les frères et sœurs éloignés"}
