# -*- coding: utf-8 -*-
"""
Kit Radio IA - Bulletin d'informations du soir (17:00 par défaut)
...
Sortie : nouvelles/bulletin_soir_AAAAMMJJ_HHMMSS.wav
Usage  : python bulletin_soir.py
"""
import sys
import re
import requests
...
- Minimum 400 mots
- Commencer EXACTEMENT par : "Bienvenue au bulletin d'informations du soir de {config.STATION_NOM}. Nous sommes le {date_fr}. Voici les nouvelles de cette fin de journée."
...
- Conclure par : "Voilà pour ce bulletin du matin sur {config.STATION_NOM}. Que Dieu veille sur vous et vos proches pour cette soirée."
- Texte parlé fluide
...
def main():
    print(f"\n=== {config.STATION_NOM} — Bulletin du soir ===")
    ...
    base_nom = f"bulletin_soir_{timestamp}"
