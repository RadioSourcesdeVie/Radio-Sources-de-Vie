...
# Prières matin/soir, Témoignages, Sermons, Sabbat School.
# Le Journal du Soir (news) est généré séparément par run_bulletin_soir.sh à 18h.
...
# 1) Textes (Claude Haiku) : prières, témoignages, sermons, sabbat
