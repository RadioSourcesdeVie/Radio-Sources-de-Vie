...
SEGMENTS = [
    ...
    {"key":"bulletin_soir","group":"news","title":"Journal du Soir — Radio Sources de Vie","description":"Journal complet 10-15 minutes, Lundi-Vendredi 18h — Voix Charline & Antoine","json_path":f"content/bulletin_soir/{TODAY}.json","mp3_path":f"audio/bulletin_soir/{TODAY}.mp3"},
]
